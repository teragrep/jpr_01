...
//        }
        ...
        while (matchfound) {
            ...
            test2 = s1.pcre2_singlematch_java("From:regular.expressions@example.com\r\n"+"From:exddd@43434.com\r\n"+"From:7853456@exgem.com\r\n", s1.offset);
            a = 0;
            for(Map.Entry<Integer,String>it:test2.entrySet()) {
                System.out.print(a+": "+it.getValue()+"\n");
                a++;
            }
            if (a==0) {
        ...
        // Another function for getting all match groups at once.
